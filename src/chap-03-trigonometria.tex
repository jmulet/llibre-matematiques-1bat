...
\answers[cols=3]{[100 m, 86.60 m, 90$^\circ$]}
	...
	\answers{cim A=827 m, cim B=751 m, distància entre cims AB=1687.3 m}
...
\begin{mylist}
	...
	\begin{tasks}(2)
		...
		\task   $\tg x-\sin 2x=0$
	\end{tasks}
	\answers[cols=1]{[$x=90+n\cdot 180$ i $x=60+n\cdot 180$ i $x=120+n\cdot 180$,  $x=n \cdot 180$ i $x=45+n\cdot 90$]}
...
\answers{Perímetre = $300\cdot \sin 36^\circ = 176,3355$ m.; \quad Àrea = 713,292 m$^2$.}
